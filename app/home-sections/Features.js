                    ...
                    <div className="">
                         ...
                         <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                              {featureData.map((feature, index) => (
                                   <div className="border-opacity-20 border-[#797DFC] bg-[#797DFC1A] border-2  rounded-2xl w-full" key={index}>
                                        ...
                                        <div className="p-10 space-y-7">
                                             ...
                                             <button href="#" className="font-bold inline-block bg-[#797DFC] hover:bg-[#797DFc] btn-sm rounded-full mt-4 text-sm text-white px-8">Learn More &#8594;</button>
                                        </div>
                                   </div>
                              ))}
                         </div>
