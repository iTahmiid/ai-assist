    ...
    return (
        <main className='max-w-7xl mx-auto'>
            ...
            <div className="text-center mb-8">
                <h1 className="text-4xl font-bold text-[#121643]">About AI-Assist</h1>
            ...
            <section className='mt-12  mx-auto'>
                ...
                <div>
                    <div>
                        <h1 className="text-4xl mb-4 font-bold  mt-44  relative">
                            Our Team
                        </h1>
            ...
            <section className="lg:flex mt-44 text-center lg:text-left items-center justify-between bg-[#121643] py-12 px-20">
                <h1 className="text-white text-4xl font-bold">Join Us on Our Journey
                </h1>
